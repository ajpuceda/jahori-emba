...
st.markdown("""
    ...
    .stApp:has(div[data-testid="stSidebar"]) div[data-testid="column"] { width: 50% !important; max-width: 50% !important; flex: 1 1 50% !important; }
...
def init_db():
    ...
    # 💡 NUEVA TABLA: Guarda el reporte de Gemini de forma persistente para no gastar tokens de nuevo
...
if "token" in query_params:
    ...
    if st.session_state.user is None:
        if st.session_state.page == "Home":
            ...
            # 💡 UX MEJORA 1: Cambiado expanded=True para que aparezca abierto por defecto al cargar la web
            ...
            # 💡 UX MEJORA 2: Texto aclaratorio sobre las credenciales libres y sin emails
...
# ===================================================================================================
        ...
        # 1. Comprobamos el estado actual del embudo del alumno
        ...
        # 💡 UX MEJORA 3: Lógica inteligente de enrutamiento forzado por pasos secuenciales (Wizard)
        if not has_self:
        ...
        if current_step == "Step 1: Self Assessment":
            ...
            # 💡 UX MEJORA 4: Bloqueo de tokens. Si ya existe un reporte en la DB, se lee directo sin llamar a Gemini
            if saved_report:
                    ...
                    if not api_key: st.error("API Secret Key missing.")
                        ...
                        with st.spinner("Gemini is analyzing your psychological vectors..."):
                            try:
                                ...
                                # Guardamos el reporte en la base de datos de forma perpetua para bloquear futuros consumos
