...
# ===================================================================================================
#    [JAHORI WINDOW SAAS - NATIVE DARK EXPANDER V24] - CONFIGURACIÓN Y ESTILOS (PART 1)
# ===================================================================================================
...
st.markdown("""
    ...
    /* 💡 REGLA DE INGENIERÍA PARA EL EXPANDER: Forzamos al acordeón nativo a ser oscuro con letras blancas */
    div[data-testid="stExpander"] {
        background-color: #0F172A !important;
        border: 1px solid #1E293B !important;
        border-radius: 8px !important;
    }
    /* Estiliza el encabezado del expander */
    div[data-testid="stExpander"] summary p {
        color: #FFFFFF !important;
        font-weight: 600 !important;
    }
    /* Estiliza los textos e hijos dentro del expander abierto */
...
# ===================================================================================================
#    [JAHORI WINDOW SAAS - NATIVE DARK EXPANDER V24] - PUBLIC PANEL & ACCESS (PART 2)
# ===================================================================================================
...
if "token" in query_params:
    ...
    if st.session_state.user is None:
        if st.session_state.page == "Home":
            ...
            # 💡 MARQUETACIÓN RECOBRADA: Markdown nativo limpio, los colores claros se aplican mediante spans de alta visibilidad
            with st.expander("ℹ️ Learn more about the Johari Window framework", expanded=True):
                st.markdown("""
                    ...
                    * <span style="color: #FBBF24 !important; font-weight: 700;">👁️ 2. Blind Area (Unknown to Self & Known to Others):</span> This is your **Blind Spot**. It encompasses behaviors, habits, or defensive mechanics that your colleagues notice in daily operations, but you are completely unaware of. Unlocking this quadrant is critical to preventing leadership failure.
